...
def main():
    ...
    parser.add_argument('--defense', type=str, default='resnet18_8x')
    ...
    num_classes = 10 if args.dataset in ['cifar10'] else 100
    args.num_classes = num_classes
    args.ckpt = f'./checkpoint/defense/defense_{args.dataset}_{args.model}.pth'
    ...
    if args.model == 'resnet34_8x':
        ...
        teacher = get_classifier(args, args.model, pretrained=False, num_classes=args.num_classes)
        teacher.load_state_dict( torch.load( args.ckpt, map_location=device) )
