...
parser.add_argument('--data', type=str, default='../Defense/cache/data/')
parser.add_argument('--output_dir', type=str, default='../Defense/cache/teacher/')
...
if args.dataset == 'MNIST':
    ...
    net = get_classifier(args, 'lenet5', pretrained=False, num_classes=10).cuda()
...
if args.dataset == 'cifar10':
    ...
    net = get_classifier(args, 'resnet34_8x', pretrained=False, num_classes=10).cuda()
    criterion = torch.nn.CrossEntropyLoss().cuda()
...
if args.dataset == 'cifar100':
    ...
    net = get_classifier(args, 'resnet34_8x', pretrained=False, num_classes=100).cuda()
    criterion = torch.nn.CrossEntropyLoss().cuda()
    optimizer = torch.optim.SGD(net.parameters(), lr=0.1, momentum=0.9, weight_decay=5e-4)
